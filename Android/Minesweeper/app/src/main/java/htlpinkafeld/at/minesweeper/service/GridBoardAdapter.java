        ...
        if(f.isFlagged()) {
            ...
            if (f.isCovered()) {
                ...
                if (f.isMine()) {
                    ...
                    switch (((Field) f).getNearMines()){
                        case 0: imageView.setImageResource(R.drawable.field_empty);
                            break;
                        case 1: imageView.setImageResource(R.drawable.field_1);
                            break;
                        case 2: imageView.setImageResource(R.drawable.field_2);
                            break;
                        case 3: imageView.setImageResource(R.drawable.field_3);
                            break;
                        case 4: imageView.setImageResource(R.drawable.field_4);
                            break;
                        case 5: imageView.setImageResource(R.drawable.field_5);
                            break;
                        case 6: imageView.setImageResource(R.drawable.field_6);
                            break;
                        case 7: imageView.setImageResource(R.drawable.field_7);
                            break;
                        case 8: imageView.setImageResource(R.drawable.field_8);
                            break;
                    }
                }
            }
