...
import at.htlpinkafeld.minesweeperv2.pojo.Field;
import at.htlpinkafeld.minesweeperv2.pojo.Game;
import at.htlpinkafeld.minesweeperv2.pojo.Mine;
...
public class FieldServiceClass {
    ...
    private FieldServiceClass(){
        ...
        for(int x=0;x< width;x++){
            for(int y=0;y< height;y++){
                if(board[x][y]==null)
                    board[x][y]=new MineField(this.getNearMines(x, y));
            }
        }
    }
    ...
    public Game getGame(){
        return new Game(-1,board,numMines, fieldsUncovered, 0);
    }

    public void loadGame(Game game){
        this.board=game.getBoard();
        fieldsUncovered=game.getFieldsUncovered();
