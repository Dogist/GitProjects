 ...
 * @author Martin Six
 */
public class OracleConnectionData extends ConnectionData {

    private String serverUrl;
    private int port;
    private String dbName;

    public OracleConnectionData(String serverUrl, int port, String dbName, String username, String password) {
        super(DAOType.ORACLE, username, password);
    ...
    public boolean equals(Object obj) {
        ...
        final OracleConnectionData other = (OracleConnectionData) obj;
